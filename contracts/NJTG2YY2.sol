    ...
    SaleState
{
        ...
        )
    {
        ...
        if (getAllowListUsed(_msgSender())) revert MintAddressUsed();
    ...
    function getAllowListUsed(address address_) public view returns (bool) {
