...
contract NJTG25Y1 is Ownable {
    address public user1; //jungleFreaks;
    address public user2; //scottA;
    address public user3; //scottT;
    address public user4; //willFan;
    address public user5; //netvrk;
    address public user6; //massless;
